...
describe('getABExperimentBucket function split accuracy', () => {
    ...
    test('Split between treatment and control is close to 50:50', () => {
        ...
        expect(Math.abs(percentageTreatment - percentageControl)).toBeLessThanOrEqual(1);
    });
    ...
    test('Split between treatment and control is close to 10:90', () => {
        ...
        const percentageTreatment = calculatePercentage(treatmentCount, iterations);
    ...
    test('Exposure of 50% results in 50% of users getting treatment or control', () => {
        ...
        const percentageTreatmentControl = ((treatmentCount + controlCount) / iterations) * 100;
        const percentageIgnore = (ignoreCount / iterations) * 100;

        // Check if percentage of treatment/control is close to 50%
        expect(Math.abs(percentageTreatmentControl - 50)).toBeLessThanOrEqual(1);
...
describe('getABExperimentBucket function edge cases and error handling', () => {
    ...
    test('Error handling', () => {
        ...
        const mockCryptoCreateHash = jest.spyOn(require('crypto'), 'createHash');
    ...
    test('Error is thrown when treatment split is less than 0', () => {
        ...
        expect(() => getABExperimentBucket(mockParams)).toThrow('treatmentSplit must be a number between 0 and 100');
    });
    ...
    test('Error is thrown when exposure is less than 0', () => {
        ...
        expect(() => getABExperimentBucket(mockParams)).toThrow('exposure must be a number between 0 and 100');
    });
